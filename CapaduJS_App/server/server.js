...
io.on('connection', (socket) => {
    ...
    socket.on('validator', (data) =>{
        ...
        getJSON('http://192.168.10.190:8000/api/validator/' + data.tocken, function(error, response){
            if (error) {
    ...
    socket.on('requestDbNames', function(tocken){
        ...
        MongoClient.connect(url, function(err, db){
            ...
            dbo.collection("CapaduGames").find().toArray(function(err, res) {
                ...
                getJSON('http://192.168.10.190:8000/api/sendcapadus/' + tocken, function(error, response){
    ...
    socket.on('newQuiz', function(data){
        MongoClient.connect(url, function(err, db){
            ...
            dbo.collection('CapaduGames').find({}).toArray(function(err, result){
                ...
                requestify.post('http://192.168.10.190:8000/api/recivecapadus/' + data.tocken, {
                    id: data.id
                });
